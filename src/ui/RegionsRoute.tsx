...
export function RegionsRoute({ load, revision, busy, initialId, onNavigate }: {
  ...
  return <DetailQuery load={request} revision={revision} label="Regions">
    {view => <RegionsPanel query={view} onQueryChange={setQuery} busy={busy} directoryOpen={directoryOpen} onDirectoryOpenChange={setDirectoryOpen} onNavigate={onNavigate} />}
  </DetailQuery>;
}
