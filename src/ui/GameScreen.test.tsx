...
describe("GameScreen", () => {
  it("renders header with end turn and save and overview by default", () => {
    ...
    render(<GameScreen {...preferencesProps} loadPolitics={loadPolitics} loadMarkets={loadMarkets} loadLegislation={loadLegislation} loadWorldOverview={loadWorldOverview} world={world} busy={false} onAdvanceTurn={vi.fn()} onSave={vi.fn()} onExit={vi.fn()} onAction={vi.fn()} />);
  ...
  it("reflects busy disabling actions and shows message and error", async () => {
    ...
    const { rerender } = render(<GameScreen {...preferencesProps} loadPolitics={loadPolitics} loadMarkets={loadMarkets} loadLegislation={loadLegislation} loadWorldOverview={loadWorldOverview} world={world} busy={true} message="Advancing" onAdvanceTurn={vi.fn()} onSave={vi.fn()} onExit={vi.fn()} onAction={onAction} />);
    ...
    rerender(<GameScreen {...preferencesProps} loadPolitics={loadPolitics} loadMarkets={loadMarkets} loadLegislation={loadLegislation} loadWorldOverview={loadWorldOverview} world={world} busy={false} error="Save failed" onAdvanceTurn={vi.fn()} onSave={vi.fn()} onExit={vi.fn()} onAction={onAction} />);
  ...
  it("invokes onAdvanceTurn, onSave, onExit", async () => {
    ...
    const onSave = vi.fn();
    const onExit = vi.fn();
    render(<GameScreen {...preferencesProps} loadPolitics={loadPolitics} loadMarkets={loadMarkets} loadLegislation={loadLegislation} loadWorldOverview={loadWorldOverview} world={world} busy={false} onAdvanceTurn={onAdvanceTurn} onSave={onSave} onExit={onExit} onAction={vi.fn()} />);
  ...
  it("performs action with params and respects disabledReason", async () => {
    ...
    render(<GameScreen {...preferencesProps} loadPolitics={loadPolitics} loadMarkets={loadMarkets} loadLegislation={loadLegislation} loadWorldOverview={loadWorldOverview} world={world} busy={false} onAdvanceTurn={vi.fn()} onSave={vi.fn()} onExit={vi.fn()} onAction={onAction} />);
    await user.click(screen.getByRole("tab", { name: "Character" }));
  ...
  it("candidacy button is disabled while busy", async () => {
    ...
    const onAction = vi.fn();
    const world = makeWorld();
    render(<GameScreen {...preferencesProps} loadPolitics={loadPolitics} loadMarkets={loadMarkets} loadLegislation={loadLegislation} loadWorldOverview={loadWorldOverview} world={world} busy={true} onAdvanceTurn={vi.fn()} onSave={vi.fn()} onExit={vi.fn()} onAction={onAction} />);
    await user.click(screen.getByRole("tab", { name: "Elections" }));
    const card = screen.getByRole("article", { name: "General Election" });
...
describe("GameScreen status footer", () => {
  ...
  it("shows processing status while busy", () => {
    const world = makeWorld();
    render(<GameScreen {...preferencesProps} loadPolitics={loadPolitics} loadMarkets={loadMarkets} loadLegislation={loadLegislation} loadWorldOverview={loadWorldOverview} world={world} busy={true} message="Advancing" onAdvanceTurn={vi.fn()} onSave={vi.fn()} onExit={vi.fn()} onAction={vi.fn()} />);
    const footer = screen.getByRole("contentinfo", { name: "Character stats and turn timer" });
...
describe("GameScreen menu keyboard flow", () => {
  it("focuses and moves between destinations, then focuses the selected page", async () => {
    const user = userEvent.setup();
    render(<GameScreen {...preferencesProps} loadPolitics={loadPolitics} loadMarkets={loadMarkets} loadLegislation={loadLegislation} loadWorldOverview={loadWorldOverview} world={makeWorld()} busy={false} onAdvanceTurn={vi.fn()} onSave={vi.fn()} onExit={vi.fn()} onAction={vi.fn()} />);
    await user.click(screen.getByRole("button", { name: "Menu" }));
