...
export function CharacterCreationScreen({
  ...
  return (
    <div className="ahd-screen">
      <div className="ahd-container" style={{ paddingTop: "max(1rem, var(--ahd-safe-area-top-fallback, 0px), env(safe-area-inset-top))", paddingBottom: "max(2rem, env(safe-area-inset-bottom))", maxWidth: "42rem" }}>
