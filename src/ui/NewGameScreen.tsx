              ...
              {previewParty ? (
                mode === "hos" ? (
                  <div className="ahd-preview-row">
                    <PartyMark name={previewParty.name} abbreviation={previewParty.abbreviation} color={previewParty.color} id={previewParty.id} countryId={countryId} logoUrl={previewParty.logoUrl} size={24} />
