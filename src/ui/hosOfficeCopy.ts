/**
 * HoS banner copy (#240 slice, on top of the #243 seating notice).
 *
 ...
 * "General Secretary", "First Secretary"). The system bucket follows the
 * AHDGame `governmentType`: parliamentary offices (parliamentaryRepublic /
 * parliamentaryMonarchy) read "Parliamentary executive", one-party offices
 * (onePartyState: generalSecretary, firstSecretary, premier) read
 * "One-party executive", and only "president" reads "Presidential executive".
 * Unknown or missing offices keep the neutral "executive office" fallback and
 * never claim a presidential system.
 */
