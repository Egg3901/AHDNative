  ...
  return {
    ...
    nation: { countryId: "US", countryName: "United States", currency: "USD",
      ...
      budget: { fiscalYear: 1953, gdpAbsolute: 100000000, population: 1000000, currency: "USD",
        ...
        links: [{ label: "Policy", route: "policy" as const }],
...
const loadMarkets = async () => ({ playerCountryId: "US", playerCash: 0, playerCurrency: "USD", playerActions: 0, turn: 0, marketsPhaseEnabled: true, economyPhaseEnabled: true, corporationsPhaseEnabled: true, countries: [], listings: [], sectors: [], tradeRoutes: [] });
