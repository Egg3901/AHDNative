 ...
 * via `world.era`, World, Regions, political metrics) pass it; callers whose
 * DTO has none (Profile) render the base engine id.
 *
...
export interface CountryFlagProps {
   ...
   * Omitted when the DTO carries no era (Profile).
   */
  era?: string | null;
