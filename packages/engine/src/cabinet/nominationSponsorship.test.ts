...
describe("#269 presidential cabinet nomination sponsorship", () => {
  ...
  it("rejects authority, country, position, vacancy, duplicate, and nominee failures atomically", () => {
    const cases = [
      ...
      (world: ReturnType<typeof presidentialWorld>, nomineeId: string) => { world.meta.date = "1953-02-30"; return () => sponsorCabinetNomination(world, { countryId: "US", positionId: "secretary_of_state", nomineeId }); },
