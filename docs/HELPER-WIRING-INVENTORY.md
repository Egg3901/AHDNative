...
| Leadership tenure and entry cooldown | Leadership contest action is live, but its catalog documents the missing 24-hour and tenure gates. | Yes | Reachable but incomplete. Tracked by [#102](https://github.com/Egg3901/AHDNative/issues/102). |
