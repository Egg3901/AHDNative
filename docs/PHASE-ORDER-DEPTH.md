...
| `bankSolvencyTurn` | same-edge | `bankSolvencyTurnPhase` follows `bankingTurnPhase`; the proprietary-book leg (mark, forced liquidation, investment-bank failure) is live per [#328](https://github.com/Egg3901/AHDNative/issues/328) and missing interbank behavior remains [#109](https://github.com/Egg3901/AHDNative/issues/109). |
