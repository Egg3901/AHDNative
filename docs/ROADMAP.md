...
- News now filters durable local records by country, date and category, opens a full offline article, and links structured country, party, election and event context. Stable record IDs plus local read/selection state preserve the open article across navigation and app reload without a network request (#78).
